...
//=================================================//   
const reply = (teks) => {
return diablo.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC XynaBotz`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"6285718828566Url": `https://youtube.com/@xynabotzreal`}}}, { quoted: m })} 	
//=================================================// 
try {
...
break
case 'akses':
diablobotwhatsapp.reply(`UNTUK AKSES BOT CHAT OWNER : wa.me/6285718828566`)
break
case 'sewa':
diablobotwhatsapp.reply(`UNTUK SEWA BOT CHAT OWNER : wa.me/6285718828566`)
break
...
jumlah = `${encodeURI(q)}`
ydd = `HALLO AKU XYNABOTZ`
for (let i = 0; i < jumlah; i++) {
var pollCreation = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"pollCreationMessage": {
"name": "HALO 👋 SAYA BOT XYNABOTZ",
"options": [
{
...
touchmebre = [
{
title: `🌷 XynaBotz 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
diablo.sendListMsg(m.chat, `🌷 XynaBotz 🌷`, diablo.user.name, `Hay Kak Sc Bot Ada Di List`, `Click Here 🌷`, touchmebre, m)
break
